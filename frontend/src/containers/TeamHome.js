...
import { List, ListItem, ListItemText, Typography, Box, Card, Button, Chip, CardContent } from '@mui/material';
...
import { EventData, ScoreData, VoteData, PostData } from "../components/ListData";
  ...
  const homepage = (
    <div className = "team-home">
        ...
        <Card className = "teamHp-event"
            ...
            {events.filter(event => event.type === "team")
                      .map(event => <Card sx={{ m:1,
                                                width: 150,
                                                height: 180,
                                                display: 'inline-block' }}
                                                key = {event.id}>
        ...
        <Card className = "teamHp-post"
            ...
            {posts.map(post => <Card sx={{ m:1.5, width: 490, height: 85, display: 'block' }}
                                     key = {post.id}>
                                    <CardActionArea sx={{ width: 500, height: 85 }}
                                                          href={`#post-detail`}>
            ...
            <Box sx={{ px: 1, width: '100%', maxWidth: 530, textAlign: 'right' }}>
              <Button variant="outlined" color="success" sx={{ m: 1 }} href = '/team/Posts'>
                View All
              </Button>
            </Box>
        </Card>

        <Card className = "teamHp-score"
              sx={{ m: 2,
                    p: 2,
                    width: 535,
                    height: 315,
            ...
            {votes.map(vote => <Card sx={{ m:1,
                                      ...
                                      <CardActionArea sx={{ width: 150,
                                        ...
                                        <CardContent sx={{ p: 2 }}>
                                          ...
                                          {vote.act ? <Chip label="投票中" color='success' variant="outlined" size = 'small'/> :
